...
@Configuration
@ComponentScan({ "com.github.seeker.si2" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.github.seeker.si2");
                servletContext.setInitParameter("tapestry.development-modules", "com.github.seeker.si2.services.DevelopmentModule");
